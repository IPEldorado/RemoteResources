 ...
 * 
 */
public class ControlPackageHandlingMessage extends CommandMessage {
	private static final long serialVersionUID = 5481207318846024671L;

	public ControlPackageHandlingMessage(int sequenceNumber,
			String serialNumber, SubType subType, String[] params) {
		super(sequenceNumber, serialNumber, ControlMessageType.HANDLE_PACKAGE,
				subType, params);
	}
