 ...
 * 
 */
public class ControlRunShellCommandMessage extends CommandMessage {

	public ControlRunShellCommandMessage(int sequenceNumber,
			String serialNumber, SubType subType, String[] params) {
		super(sequenceNumber, serialNumber,
				ControlMessageType.RUN_SHELL_COMMAND, subType, params);
	}
